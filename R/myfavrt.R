#' Allow users get real-time information of favorite routes.
#'
...
#' current status, and alert message. It also allows users to collect and save the
...
#' @export
#' @examples
#' myfavrt(bus = 126, start_id = 36, end_id = 14484, interval= 0, times = 1)
